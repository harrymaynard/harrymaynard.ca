export const INITIAL_SIZE = 500;
export const INITIAL_WIND = [10.0, 10.0];
export const INITIAL_CHOPPINESS = 2.5; // 1.5
...
export const EXPOSURE = 0.35; // Brightness.
export const GEOMETRY_RESOLUTION = 256;
...
export const SPECTRUM_UNIT = 1;
export const DISPLACEMENT_MAP_UNIT = 2;
export const NORMAL_MAP_UNIT = 3;
export const PING_PHASE_UNIT = 4;
export const PONG_PHASE_UNIT = 5;
export const PING_TRANSFORM_UNIT = 6;
export const PONG_TRANSFORM_UNIT = 7;

export const UI_COLOR = 'rgb(52, 137, 189)';

export const PROFILE_AMPLITUDE = 50;
export const PROFILE_OMEGA = 0.05;
export const PROFILE_PHI = -2.5;
export const PROFILE_STEP = 5;
export const PROFILE_OFFSET = 52;
export const PROFILE_COLOR = 'rgb(52, 137, 189)';
export const PROFILE_LINE_WIDTH = 3;
export const CHOPPINESS_SCALE = 0.15;

export const ARROW_ORIGIN = [-1250, 0, 500];
export const ARROW_SHAFT_WIDTH = 80;
export const ARROW_HEAD_WIDTH = 160;
export const ARROW_HEAD_HEIGHT = 60;
export const ARROW_OFFSET = 40;
export const WIND_SCALE = 8.0;
export const MIN_WIND_SPEED = 5.0;
export const MAX_WIND_SPEED = 25.0;

export const HANDLE_COLOR = '#666666';
export const SLIDER_LEFT_COLOR = UI_COLOR;
export const SLIDER_RIGHT_COLOR = '#999999';
...
export const SIZE_DECIMAL_PLACES = 0;
export const CHOPPINESS_DECIMAL_PLACES = 1;

export const SENSITIVITY = 1.0;

export const WIND_SPEED_X = -1350;
export const MIN_WIND_SPEED_Z = 600;
export const WIND_SPEED_OFFSET = 30;

export const OVERLAY_DIV_ID = 'overlay';
export const PROFILE_CANVAS_ID = 'profile';
export const SIMULATOR_CANVAS_ID = 'simulator';
export const UI_DIV_ID = 'ui';
export const CAMERA_DIV_ID = 'camera';
export const WIND_SPEED_DIV_ID = 'wind';
export const WIND_SPEED_SPAN_ID = 'wind-speed';
export const CHOPPINESS_DIV_ID = 'choppiness';

export const SIZE_SLIDER_X = -200;
export const SIZE_SLIDER_Z = 1100;
export const SIZE_SLIDER_LENGTH = 400;
export const MIN_SIZE = 100;
export const MAX_SIZE = 1000;
export const SIZE_SLIDER_BREADTH = 3;
export const SIZE_HANDLE_SIZE = 24;

export const CHOPPINESS_SLIDER_X = -1420;
export const CHOPPINESS_SLIDER_Z = 75;
export const CHOPPINESS_SLIDER_LENGTH = 300;
export const MIN_CHOPPINESS = 0;
export const MAX_CHOPPINESS = 2.5;
export const CHOPPINESS_SLIDER_BREADTH = 6;
export const CHOPPINESS_HANDLE_SIZE = 30;

export const ARROW_TIP_RADIUS = 100;
export const SIZE_HANDLE_RADIUS = 30;
export const CHOPPINESS_HANDLE_RADIUS = 100;

export const NONE = 0;
export const ORBITING = 1;
export const ROTATING = 2;
export const SLIDING_SIZE = 3;
export const SLIDING_CHOPPINESS = 4;

export const CAMERA_DISTANCE = 2000; // 1500
export const ORBIT_POINT = [0,0,0]; // -200.0, 0.0, 600.0
export const INITIAL_AZIMUTH = 0; // 0.4
export const INITIAL_ELEVATION = 0.5; // 0.5
export const MIN_AZIMUTH = -0.2;
export const MAX_AZIMUTH = 0.5;
export const MIN_ELEVATION = 0.4;
export const MAX_ELEVATION = 0.8;
...
export const premultiplyMatrix = function (out, matrixA, matrixB) {
    ...
    // @ts-expect-error: Used in matrix calculation.
    aX = matrixA[4]
    aY = matrixA[5]
    aZ = matrixA[6]
    aW = matrixA[7]
...
export const buildProgramWrapper = function (gl, vertexShader, fragmentShader, attributeLocations) {
...
export const buildTexture = function (gl, unit, format, type, width, height, data, wrapS, wrapT, minFilter, magFilter) {
...
export const toCSSMatrix = function (m) { //flip y to make css and webgl coordinates consistent
    return 'matrix3d(' +
        epsilon(m[0]) + ',' +
        -epsilon(m[1]) + ',' +
        epsilon(m[2]) + ',' +
